...
**Out:** /workspace/.cursor/skills/verify-grom/evidence/20260902-124838
**OK:** true
**When:** 2026-09-02T12:48:38.381Z → 2026-09-02T12:48:43.068Z
...
- Warszawa (default, `01-warszawa-sheet.png`): sheet ready with **Opad nadciąga** · TERYT **1465**.
...
- Doctor: `analysisSource: sri`, radar age 3.2 min, `overlayCount: 7`, `echoCount: 3989`. Live snapshot on Warszawa (`52.2297, 21.0122`, TERYT `1465`).
- IMGW warnings + PERUN unavailable — skipped those assertions.

Identity slice is live on this instance: 2-cell link + core tracking, with the #39 dense field kept. This drive only proves the pin still works; cores-vs-tiles is in `threat.test.ts`.
