...
**Out:** /workspace/.cursor/skills/verify-grom/evidence/20260902-101720
**OK:** true
**When:** 2026-09-02T10:17:20.504Z → 2026-09-02T10:17:23.922Z
...
- Warszawa: **Czysto** · Szansa 10% · ETA minie · Echo 35 km · miss ~47 km · Idzie od zachodu → na wschód 45 km/h.
- Kraków: **Czysto** · Szansa 10% · ETA teraz · Echo 3 km · słaby · Idzie od zachodu → na wschód 28 km/h · Spodziewaj się: słaby deszcz.
- Doctor: `analysisSource: sri`, radar age 2.3 min, `overlayCount: 7`, `echoCount: 3303`. Live `getSnapshot` `radar.cellKm` is **3** (quiet/moderate day, under the 9 000 cap).
- IMGW + PERUN unavailable.
